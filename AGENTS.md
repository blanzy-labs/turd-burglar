# Turd Burglar agent authority

This repository is operated through Game Foundry with the following authority
hierarchy:
...
Deterministic failures are failures; agent prose cannot override them. Keep the
TB-001 scope crude, dependency-free, and limited to the requested first loop.
